...
const PdfCompressor = () => {
  ...
  const [level, setLevel] = useState(40); // percentage
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className={`mb-8 p-6 md:p-8 rounded-2xl shadow-xl ${isDark ? 'bg-[#020617]' : 'bg-white'}`}>
            ...
            <p className={`${isDark ? 'text-[#94A3B8]' : 'text-[#64748B]'} mb-4`}>
              Adjust the compression level to see how the estimated file size would change. This
              is a purely visual demo.
            </p>
          </div>
          ...
          <div className={`p-6 md:p-8 rounded-2xl shadow-xl ${isDark ? 'bg-[#020617]' : 'bg-white'}`}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <label className={`block text-sm font-medium mt-4 mb-1 ${isDark ? 'text-white' : 'text-[#1E293B]'}`}>
                  Original Size (KB)
                </label>
                <input
                  type="number"
