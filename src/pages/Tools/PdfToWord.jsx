...
const PdfToWord = () => {
  ...
  const handleConvert = (e) => {
    ...
    // Frontend-only: fake page count based on file name length
                ...
                {converted ? (
                  <div className="flex items-start space-x-3 text-sm">
                    ...
                    <div className={isDark ? 'text-[#E2E8F0]' : 'text-[#0F172A]'}>
                      <p className="font-medium mb-1">{fileName.replace(/\.pdf$/i, '') || 'document'} .docx</p>
                      <p>
                        Your PDF has been "converted" into a Word document with approximately {pages} page
                        {pages !== 1 ? 's' : ''}. In a real implementation, the converted file would be downloaded
                        here.
                      </p>
                    </div>
                  </div>
