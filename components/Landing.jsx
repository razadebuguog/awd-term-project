...
const features = [
  {
    ...
    description:
      'Leverage our optimized engine for the fastest document transformations available.',
    icon: Zap,
  },
  {
    title: 'Secure & Private',
    description:
      'Your files are processed using end-to-end encryption and deleted immediately after use.',
    icon: Shield,
  },
  {
    title: 'Unlimited Revisions',
    description:
      'Convert, edit, and re-convert documents as many times as you need with a single subscription.',
    icon: RefreshCcw,
  },
];
  ...
  <section className="pt-32 pb-16 md:pt-48 md:pb-24 bg-[#F9FAFB] dark:bg-[#0F172A] transition-colors duration-300">
    <div className="container mx-auto px-4 text-center max-w-5xl">
      ...
      <p className="text-xl sm:text-2xl text-[#64748B] dark:text-[#64748B] mb-12 max-w-3xl mx-auto font-light">
        UniConvert provides seamless, accurate, and rapid conversion for all your needs: PDF, Word,
        Image, and HTML.
      </p>
        ...
        {coreServices.map((service, index) => (
          ...
          >
            <div className="flex items-center space-x-4 mb-4">
              <service.icon
                className="text-[#06B6D4] transition-colors duration-300 group-hover:text-[#1E293B] dark:group-hover:text-white"
                size={40}
                strokeWidth={2}
              />
            ...
            <p className="text-[#64748B] dark:text-[#64748B] text-base">{service.description}</p>
    ...
    <div className="container mx-auto px-4 max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        {features.map((feature, index) => (
          <div
            key={index}
            className="text-center p-8 bg-white/10 dark:bg-[#64748B]/30 rounded-3xl shadow-2xl"
          >
            <feature.icon className="text-[#06B6D4] mx-auto mb-4" size={48} strokeWidth={2} />
            <h3 className="text-2xl font-bold text-[#F9FAFB] mb-3">{feature.title}</h3>
  ...
  <section className="py-20 md:py-32 bg-[#F9FAFB] dark:bg-[#0F172A] transition-colors duration-300">
    <div className="container mx-auto px-4 max-w-4xl text-center">
      ...
      <p className="text-xl text-[#64748B] dark:text-[#64748B] mb-10">
        Join thousands of professionals who trust UniConvert for their document conversion
        needs.
      </p>
      <Link
        href="/register"
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10">
            <div className="col-span-2 lg:col-span-2">
              <Link
                href="/"
                className="text-3xl font-extrabold text-[#1E293B] dark:text-[#F9FAFB] mb-4 block"
              >
                UniConvert
              </Link>
              <p className="text-sm text-[#64748B] dark:text-[#64748B] max-w-sm">
                Your trusted partner for effortless and secure document transformation. Convert
                anything, anywhere.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <Link
                    href="/"
                    className="text-[#64748B] dark:text-[#64748B] hover:text-[#06B6D4] dark:hover:text-[#F9FAFB] transition duration-150"
                  >
                    Home
                  </Link>
                </li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li>
                  <Link
                    href="/services"
                    className="text-[#06B6D4] dark:text-[#F9FAFB] hover:underline transition duration-150 font-medium"
                  >
                    View All Tools
                  </Link>
                </li>
