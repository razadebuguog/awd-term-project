      ...
      <main className="pt-28 pb-16 md:pt-32 md:pb-24">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div
              className={`p-8 md:p-12 ${cardBgColor} rounded-2xl shadow-2xl shadow-gray-200/50 dark:shadow-black/20`}
            >
              <h2 className={`text-3xl font-bold ${headingColor} mb-6`}>
                Send us a message
              </h2>
              <form className="space-y-6">
                <div>
                  <label
                    htmlFor="name"
                    className={`block text-sm font-medium ${headingColor} mb-2`}
                  >
                    Full Name
                  </label>
                  <input
            ...
            <div
              className={`p-8 md:p-12 ${cardBgColor} rounded-2xl shadow-xl shadow-gray-200/50 dark:shadow-black/20 lg:mt-16`}
            >
              <h2 className={`text-3xl font-bold ${headingColor} mb-6`}>
                Contact Details
              </h2>
              <p className={`${subTextColor} mb-8`}>
                Prefer to reach out directly? Use the information below to connect with our
                support team.
              </p>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:awd.doctypechanger2@gmail.com"
                      className={`text-lg hover:text-[#06B6D4] ${subTextColor} transition duration-150`}
                    >
